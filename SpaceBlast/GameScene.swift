...
//  SpaceBlast
//
//  Created by Jeanie House on 2/9/15.
...
class GameScene: SKScene {
    ...
    func createMoon() {
        ...
        //        let crater = SKShapeNode(ellipseOfSize: CGSizeMake(50, 50))
        //
        //        crater.fillColor = SKColor(white: 0.7, alpha: 1.0)
        //
        //        crater.position = CGPointZero
        //
